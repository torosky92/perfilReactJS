export const Experience = [
    {
        ...
        Description:{
            Spanish:'Encargado de realizar desarrollos en backend con python en toda la empresa utilizando las herramientas necesarias, como Docker, Postgres, Flask y MongoDB. Analizando mejoras en todo los sistemas para optimizar procesos',
            English:'Responsible for carrying out backend development with python throughout the company using the necessary tools, such as Docker, Postgres, Flask and MongoDB. Analyzing improvements in all systems to optimize processes',
        },
        Factory:'Serempre',
    ...
    {
        Position:{
            Spanish:'Ayudante de Semillero de Investigación SIAI',
    ...
    },
    {
        ...
        Description:{
            Spanish:'Asesoría al cliente durante período vacacional, temporadas vacacionales de mitad y fin de año',
            English:'Advice to the client during the holiday period, mid-year and end-of-year holiday seasons.',
        },
...
export const ReferenceLAB = [
    {
        Position:{
            Spanish:'Ingeniero de Eléctrico',
            English:'Electric Engineern',
        },
        Name:'Walter CANO',
        Factory:'GL INGENIEROS',
        Contact:'300-737-94-94',
        Places: 'Pereira, Antioquia',
    },
    {
        Position:{
            Spanish:'Profesor de Ingeniería de Producción',
            English:'Professor of Production Engineering',
        },
        Name:'Davison CASTAÑO CANO',
        Factory:'EAFIT',
        Contact:'dcasta25@eafit.edu.co',
        Places: 'Medellín, Antioquia',
    },
    {
        Position:{
            Spanish:'Coordinador de laboratorios',
            English:'Laboratory coordinator',
        },
        Name:'Hugo Alberto MURILLO HOYOS',
        Factory:'EAFIT',
        Contact:'hmurillo@eafit.edu.co',
        Places: 'Medellín, Antioquia',
    },
    {
        Position:{
        ...
        Name:'Silvia VILLA VILLA',
        Factory:'REDEPESCA SAS',
        Contact:'310-461-48-96',
        Places: 'Medellín, Antioquia',
    },
]